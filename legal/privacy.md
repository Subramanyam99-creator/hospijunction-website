...
| Processing appointment bookings | Contract |
| Communicating booking confirmations, queue updates, reminders | Contract |
| Processing payments via Razorpay | Contract |
...
| Complying with legal obligations (tax records, etc.) | Legal obligation |
